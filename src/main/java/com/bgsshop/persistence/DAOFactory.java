...
import com.bgsshop.persistence.postgres.PostgresDAOFactory;

public abstract class DAOFactory {
	
	            /* Change this line to change factory */
	private static final DAOFactory factory = new PostgresDAOFactory();
